...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Email login user:", userCredential.user);       alert("Signup successful!");
      navigate("/home");
    } catch (err: any) {
      alert(err.message);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-rose-50 to-pink-200 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Empowering your health journey</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">
            ...
            <a href="/login" className="text-pink-500 hover:text-pink-600 font-medium underline">
              Sign in here
            </a>
          </p>
        </div>
